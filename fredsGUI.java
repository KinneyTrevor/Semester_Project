...
public class fredsGUI extends JFrame
{
    // fields
	...
	try
	{
	    ge.registerFont(Font.createFont(Font.TRUETYPE_FONT,
		    fredsGUI.class.getClass().getResourceAsStream("/fonts/digital-7Mono.ttf")));
	    ge.registerFont(Font.createFont(Font.TRUETYPE_FONT,
		    fredsGUI.class.getClass().getResourceAsStream("/fonts/digital-7Italic.ttf")));
	    ge.registerFont(Font.createFont(Font.TRUETYPE_FONT,
		    fredsGUI.class.getClass().getResourceAsStream("/fonts/futurism.ttf")));
	    ge.registerFont(Font.createFont(Font.TRUETYPE_FONT,
		    fredsGUI.class.getClass().getResourceAsStream("/fonts/NotoSans.ttf")));
	}
...
//	find out what fonts are registered
