	...
	private void initialize() {
		...
		try {
			ge.registerFont(Font.createFont(Font.TRUETYPE_FONT,
					fredsGUI.class.getResourceAsStream("/fonts/digital-7Mono.ttf")));
			ge.registerFont(Font.createFont(Font.TRUETYPE_FONT,
					fredsGUI.class.getResourceAsStream("/fonts/digital-7Italic.ttf")));
			ge.registerFont(
					Font.createFont(Font.TRUETYPE_FONT, fredsGUI.class.getResourceAsStream("/fonts/FUTURISM.TTF")));
			ge.registerFont(
					Font.createFont(Font.TRUETYPE_FONT, fredsGUI.class.getResourceAsStream("/fonts/NotoSans.ttf")));
