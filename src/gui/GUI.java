...
public class GUI
{
	...
	try
	{
	    ge.registerFont(Font.createFont(Font.TRUETYPE_FONT,
		    GUI.class.getClass().getResourceAsStream("/fonts/digital-7Mono.ttf")));
	    ge.registerFont(Font.createFont(Font.TRUETYPE_FONT,
		    GUI.class.getClass().getResourceAsStream("/fonts/digital-7Italic.ttf")));
	    ge.registerFont(Font.createFont(Font.TRUETYPE_FONT,
		    GUI.class.getClass().getResourceAsStream("/fonts/futurism.ttf")));
	    ge.registerFont(Font.createFont(Font.TRUETYPE_FONT,
		    GUI.class.getClass().getResourceAsStream("/fonts/NotoSans.ttf")));
	}
